    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          // 색상/테두리/그림자 (토큰 제거)
          "bg-[#222] text-gray-100 border border-white/10 shadow-md",
          className
        )}
        {...props}
      />
  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[inset]:pl-8",
        // 아이콘 기본 색/크기
        "[&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='text-'])]:text-gray-400 [&_svg:not([class*='size-'])]:size-4",
        // 파괴적 변형
        "data-[variant=destructive]:text-red-400 data-[variant=destructive]:hover:bg-red-500/10 data-[variant=destructive]:focus:bg-red-500/15 data-[variant=destructive]:focus:text-red-300",
        className
      )}
      {...props}
    />
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn("px-2 py-1.5 text-sm font-medium text-gray-400 data-[inset]:pl-8", className)}
      {...props}
    />
  )
}
function DropdownMenuSeparator({
  ...
  return (
    <DropdownMenuPrimitive.Separator
      ...
      className={cn("my-1 -mx-1 h-px bg-white/10", className)}
      {...props}
    />
  )
}
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger
      ...
      className={cn(
        ...
        "text-gray-200 hover:bg-white/10 hover:text-white focus:bg-white/10 focus:text-white data-[state=open]:bg-white/12 data-[state=open]:text-white",
        "focus-visible:ring-[3px] focus-visible:ring-white/30 focus-visible:outline-1",
        "data-[inset]:pl-8",
        className
      )}
  ...
  return (
    <DropdownMenuPrimitive.SubContent
      ...
      className={cn(
        ...
        "bg-[#222] text-gray-100 border border-white/10 shadow-lg",
        // 애니메이션 유지
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
        className
      )}
