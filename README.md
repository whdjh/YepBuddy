...
YepBuddy는 운동 기록과 프로틴 가격 추적을 제공하는 Expo와 React Native 기반 iOS 및 Android 피트니스 앱입니다.
...
개인 프로젝트에서 모바일, 웹과 워커를 별도 저장소로 운영하면 PR, 설정, 자동화 워크플로 등 관리해야 할 지점이 늘어납니다. 특히 프로틴 가격 기능은 워커의 수집부터 Supabase 저장, 모바일 앱의 조회까지 하나의 흐름으로 연결됩니다.
...
- [앱 강제 종료 후 진행 중 운동 세션 복원](mobile/README.md#앱-강제-종료-후-진행-중-운동-세션-복원)
- [React Native와 HealthKit 운동 세션 연동](mobile/README.md#react-native와-healthkit-운동-세션-연동)

### Worker

- [가격 이력을 구매 판단 정보로 전환한 프로틴 가격 추적](worker/README.md#가격-이력을-구매-판단-정보로-전환한-프로틴-가격-추적)
